...
ViewsRouter.route("/site-settings").get(viewsController.getSiteSettingsPage)
ViewsRouter.route("/bookings").get(viewsController.getBookingPage)
...
ViewsRouter.route("/replies/:id").get(viewsController.getRepliesPage)
...
ViewsRouter.route("/add-destination").get(viewsController.getAddDestinationPage)
ViewsRouter.route("/add-hotel").get(viewsController.getAddHotelPage)
...
ViewsRouter.route("/dest-edit/:id").get(viewsController.getEditDestinationPage)
ViewsRouter.route("/hotel-edit/:id").get(viewsController.getEditHotelPage)
ViewsRouter.route("/rest-edit/:id").get(viewsController.getEditRestaurantPage)
ViewsRouter.route("/tour-edit/:id").get(viewsController.getEditTourPage)
